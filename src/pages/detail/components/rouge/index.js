        ...
        <ul className={cx('info')}>
          ...
          <li>
            ...
            <p className={cx(['desc', 'small'])}>
              ...
              폴리글리세릴-2트라이아이소스테아레이트, 솔비탄아이소스테아레이트, 1,2-헥산다이올, 황색5호, 적색104호의(1), 티타늄디옥사이드,
              향료, 리날룰, 패션프룻씨오일, 바오밥나무씨오일, 코코넛야자오일, 스위트아몬드오일, 브라질넛씨오일, 아보카도오일,
              해바라기씨오일, 리모넨, 포트마리골드꽃, 토코페롤
            </p>
          </li>
        </ul>
      </div>
        ...
        <div className={cx('productInfo')}>
          ...
          <ul className={cx('info')}>
            <li>
              ...
              <span className={cx('desc')}>르브레 코코 컬러 멀티밤 루즈(6.7g)</span>
            </li>
            <li>
